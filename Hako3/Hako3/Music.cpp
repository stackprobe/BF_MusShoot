...
singleton_VTI(MusicVolumeList, autoList<double>, makeList(MUSIC_MAX, (double)0.5))
...
static singleton_VTI(RequestQueue, autoQueue<Request_t>, new autoQueue<Request_t>(256))
...
void MusicFadeout(int frmcnt)
{
	...
	errorCase(frmcnt < 1 || IMAX < frmcnt);
