...
singleton_VTI(SELoadedList, autoList<int>,    makeList(SE_MAX, 0))   // 0 or 'not 0'
singleton_VTI(SEVolumeList, autoList<double>, makeList(SE_MAX, 0.5)) // 0.0 - 1.0 (default: 0.5)
...
static singleton_VTI(RequestQueue, autoQueue<int>, new autoQueue<int>(256))
...
static singleton_VTI(EchoResnoQueue, autoQueue<int>, new autoQueue<int>(ECHO_MAX))
static singleton_VTI(EchoIndexQueue, autoQueue<int>, new autoQueue<int>(ECHO_MAX))
